...
### Installing PlatONE
PlatONE supports Linux operating environments，Please refer to the [Installation Instructions](en-us/basics/[English]-installation) to install PlatONE.
...
If you want to test or run PlatONE locally，see [Installation Instructions](en-us/basics/[English]-installation), or the instructions below.
...
```
cd  PlatONE-Workspace/chain/PlatONE_linux/bin
